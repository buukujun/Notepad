...
public class NotesList extends ListActivity implements SearchView.OnQueryTextListener{
     ...
     * 将显示名称转换为数据库常量
     */
    private String getCategoryConstant(String displayName) {
        switch (displayName) {
            case "filter_thing": return NotePad.Notes.CATEGORY_THING;
            case "filter_record": return NotePad.Notes.CATEGORY_RECORD;
            case "filter_essay": return NotePad.Notes.CATEGORY_ESSAY;
            case "filter_other": return NotePad.Notes.CATEGORY_OTHER;
            default: return NotePad.Notes.CATEGORY_OTHER;
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (itemId == R.id.filter_thing) {
            setCategoryFilter("filter_thing");
        } else if (itemId == R.id.filter_record) {
            setCategoryFilter("filter_record");
        } else if (itemId == R.id.filter_essay) {
            setCategoryFilter("filter_essay");
        } else if (itemId == R.id.filter_other) {
